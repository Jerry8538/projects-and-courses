...
(check-expect (map2 sqr (list 2)) (list 4))
(check-expect (map2 sqrt (list 9 25)) (list 3 5))
...
;; given pred and (list n0 n1 ...) return list of numbers that return true when given as input to pred
