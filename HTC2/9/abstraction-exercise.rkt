...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname abstraction-exercise) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
